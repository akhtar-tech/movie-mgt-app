    ...
    <div className="container mx-auto my-4 m-1 p-1 relative" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      {!isLoading && (
        <button 
          ...
          className="absolute left-0 z-10 h-[40%] w-9 rounded"
        ...
        {isLoading
          ...
          : movies.map(movie => (
              ...
              >
                ...
                <p className="my-1 text-center text-wrap break-word">Rating: {movie.vote_average}</p>
      ...
      {!isLoading && (
        <button 
          ...
          onMouseEnter={handleMouseEnter} 
          className="absolute right-0 z-10 h-[40%] w-9 rounded"
          style={{ top: '50%', transform: 'translateY(-75%)' }}
        >
