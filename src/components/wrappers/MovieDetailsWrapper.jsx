        ...
        >
            ...
            ">
                ...
                <div className="movie-info ml-5">
                    ...
                    <div className="genres text-md text-gray-300 my-1">Cast: {movie.credits.cast.map(cast => <span>{cast.name}</span>)}</div>
                    <div className="genres text-md text-gray-300 my-1">Related Movies: {movie.similar.results.map(similar => <span>{similar.title}</span>)}</div>
                </div>
            </div>
        </div>
    );
